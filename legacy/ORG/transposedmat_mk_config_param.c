...
void getparams(char *inputfilename)
{
  ...
  do {
    ...
    if (strcasecmp(token,"outfile")==0) {
      ...
      drehmatrix1[0][1]=m1_x.y;
      drehmatrix1[0][2]=m1_x.z;
     }
      else if (strcasecmp(token,"rotmat1_y")==0) {
      /* vector of rotation axis2 */
      getparam("rotmat1_y",&m1_y,PARAM_REAL,3,3);
      drehmatrix1[1][0]=m1_y.x;
      drehmatrix1[1][1]=m1_y.y;
      drehmatrix1[1][2]=m1_y.z;
    }
       else if (strcasecmp(token,"rotmat1_z")==0) {
      /* vector of rotation axis2 */
      getparam("rotmat1_z",&m1_z,PARAM_REAL,3,3);
      drehmatrix1[2][0]=m1_z.x;
      drehmatrix1[2][1]=m1_z.y;
